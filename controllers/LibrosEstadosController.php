 ...
 */
class LibrosEstadosController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    /**
     * Lists all LibrosEstados models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new LibrosEstadosSearch();
    ...
    /**
     * Creates a new LibrosEstados model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new LibrosEstados();
    ...
    {
        if (($model = LibrosEstados::findOne($id)) !== null) {
            return $model;
        }
